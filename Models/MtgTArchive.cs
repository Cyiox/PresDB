...
public partial class MtgTArchive
{
    ...
    public string? FinalEndorsementDate { get; set; }

    public int? OriginalMortgageAmount { get; set; }
    ...
    public string? TypeClaimNonClaim { get; set; }
